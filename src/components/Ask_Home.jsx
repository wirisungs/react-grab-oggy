        ...
        <div>
            ...
            <div className={hidden ? 'hidden' : undefined}>
                ...
                <ol className="text-sm">
                    ...
                    <li className="p-3"><span className="font-bold">Delivery </span><span>- GrabFood has designed a seamless customer journey for you, so you can enjoy your food hassle-free. We will send you an instant email and SMS confirming your order and expected delivery time. Your food is then on its way.</span></li>
                </ol>
                {HR}
                <Title content={'Does GrabFood provide food delivery 24x7?'}></Title>
                <p className="text-sm">We understand only one language - food, so yes, we do.. Please note, though we are here as your 24x7 food partners, few of our listed restaurants may have late-night food delivery restrictions or may be unavailable for orders. But we have listed the ones that love your late-night binging in our Late Night Delivery Section.</p>
                <Title content={'Does GrabFood accept Cash?'}></Title>
                <p className="text-sm">Sure, we do! GrabFood accepts all forms of payments for food delivery services, including cash on delivery.</p>
            </div>
        </div>
    );
}