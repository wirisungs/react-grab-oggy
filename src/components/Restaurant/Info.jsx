export default function Info(props){
    return(
        <div className="w-full mt-[100px]">
            ...
            <h1 className="font-bold text-5xl mt-3">{props.name}</h1>
            ...
            <div><span className="text-[15px]">Giờ mở cửa</span>  &nbsp;&nbsp; <span className="text-[15px] text-[#707070]">Cả năm  00:00-24:59</span></div>
            <div className="flex mt-2">
                <img src="https://food.grab.com/vn/en/static/images/icons/icon-promo-tag.svg"></img>
                &nbsp;
                <span>{props.promo}</span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="" className="text-[#00A5CF]">Chi tiết</a>
            </div>
        </div>
    );
}